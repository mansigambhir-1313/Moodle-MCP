...
| **subjects** (primary) | `list_subjects`, `subject_performance`, `section_compare`, `assessment_breakdown`, `subject_difficulty` | raw courses / marks / attendance |
| **insights** ⭐ (primary) | `student_trajectory`, `student_360`, `cohort_pulse`, `watchlist`, `declining_students` | cross-trimester + single-pane |
